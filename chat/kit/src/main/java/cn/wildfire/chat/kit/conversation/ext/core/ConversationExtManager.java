...
import cn.wildfire.chat.kit.conversation.ext.BonusExt;
...
import cn.wildfire.chat.kit.conversation.ext.MoreExt;
import cn.wildfire.chat.kit.conversation.ext.ShootExt;
import cn.wildfire.chat.kit.conversation.ext.TransferExt;
...
public class ConversationExtManager {
    ...
    private void init() {
        ...
        registerExt(BonusExt.class);
        registerExt(TransferExt.class);
        registerExt(FileExt.class);
        // registerExt(MoreExt.class);
    }
