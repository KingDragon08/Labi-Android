...
import cn.wildfire.chat.app.dialog.HistoryDialog;
import cn.wildfire.chat.app.main.GameDetailActivity;
...
//        getWindow().setBackgroundDrawableResource(R.mipmap.splash);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_conversation_info) {
            ...
            HistoryDialog historyDialog = new HistoryDialog(getApplicationContext(), ConversationActivity.this);
            historyDialog.show(new SimpleCallback<String>() {
                @Override
                public void onUiSuccess(String id) {
