...
public class CycleViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.ads_scroller, this, true);
    ...
    public void setData(List<Ads> list, ImageCycleViewListener listener) {
    ...
    private View getImageView(Context context, String url) {
        return GameClubFragment.getImageView(context, url);
    }
