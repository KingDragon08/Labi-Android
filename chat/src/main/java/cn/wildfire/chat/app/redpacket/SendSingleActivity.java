...
public class SendSingleActivity extends BaseSendActivity implements PasswordEditText.PasswordFullListener {
    ...
    public void initListener() {
        ...
        this.et_amount.addTextChangedListener(new MyTextWatcher() {
            public void afterTextChanged(Editable param1Editable) {
                ...
                SendSingleActivity.this.checkAmount();
            }
        });
        ...
        this.btn_putin.setOnClickListener(new View.OnClickListener() {
            public void onClick(View param1View) {
                if (!m.a()) {
                    SendSingleActivity.this.valiPwd();
                }
            }
        });
    }
        ...
        this.et_peak_message.addTextChangedListener(new MyTextWatcher() {
            public void afterTextChanged(Editable param1Editable) {
                ...
                if (param1Editable.toString().length() >= 25) {
                    ToastUtil.showToast(SendSingleActivity.this, SendSingleActivity.this.getString(R.string.red_envelope_blessing));
                }
            }
        });
    }
    ...
    public void passwordFull(String password) {
        ...
        OKHttpHelper.post(Config.APIS().get("SendBonus"), params, new SimpleCallback<SendBonusResult>() {
            ...
            public void onUiSuccess(SendBonusResult result) {
                ...
                bundle.putString("targetId", SendSingleActivity.this.target);
            ...
            public void onUiFailure(int code, String msg) {
                bottomSheetDialog.hide();
                ToastUtil.showToast( SendSingleActivity.this.context, "发送红包失败:" + msg);
            }
        });
    }
}
