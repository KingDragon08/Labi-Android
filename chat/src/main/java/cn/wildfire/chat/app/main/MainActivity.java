...
public class MainActivity extends WfcBaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void showUnreadMessageBadgeView(int count) {
        if (unreadMessageUnreadBadgeView == null) {
            ...
            unreadMessageUnreadBadgeView.setGravityOffset((int)(w*0.25), 10, false);
        }
    ...
    private void showUnreadFriendRequestBadgeView(int count) {
        if (unreadFriendRequestBadgeView == null) {
            ...
            int w = view.getMeasuredWidth();
            // unreadFriendRequestBadgeView.setGravityOffset((int)(w*0.25), 10, false);
        }
    ...
    private void initView() {
        ...
        GameMeFragment gameMeFragment = new GameMeFragment();
        GameSettingFragment gameSettingFragment = new GameSettingFragment();
        mFragmentList.add(gameClubFragment);
        mFragmentList.add(gameMeFragment);
        mFragmentList.add(gameSettingFragment);
...
//        }
    ...
    public void onPageSelected(int position) {
        switch (position) {
            case 0:
                bottomNavigationView.setSelectedItemId(R.id.club);
                setTitle(R.string.main_club);
                break;
            case 1:
                bottomNavigationView.setSelectedItemId(R.id.me);
                setTitle(R.string.main_me);
                break;
            case 2:
