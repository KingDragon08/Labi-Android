...
public interface MessageContentType {
    ...
    //自定义消息type要做1000以上
    int ContentType_Lucky_Money = 2001; // 单发红包
    int ContentType_Lucky_Money_AGroup = 2002; // 群组红包
    int ContentType_Transfer_Money = 2003; // 转账红包
    int ContentType_Lucky_Money_Accept_Single = 3001; // 领取单发红包
    int ContentType_Lucky_Money_Accept_AGroup = 3002; // 领取群组发红包
    int ContentType_Transfer_Money_Accept = 3003; // 领取转账
}
