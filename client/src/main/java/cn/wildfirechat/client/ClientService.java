...
public class ClientService extends Service implements SdtLogic.ICallBack,
    ...
    public void onCreate() {
        ...
        try {
            ...
            mBinder.registerMessageContent(LuckyMoneyMessageContent.class.getName());
            mBinder.registerMessageContent(LuckyMoneyReceiveMessageContent.class.getName());
            mBinder.registerMessageContent(LuckyMoneyGroupMessageContent.class.getName());
            mBinder.registerMessageContent(LuckyMoneyGroupReceiveMessageContent.class.getName());
